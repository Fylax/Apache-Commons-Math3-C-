...
{
    /// <summary>
    /// Default implementation of the <see cref="FieldMatrixChangingVisitor"/> interface.
    /// <para>
    ...
    public class DefaultFieldMatrixChangingVisitor<T> : FieldMatrixChangingVisitor<T> where T : FieldElement<T>
    {
        /// <summary>
